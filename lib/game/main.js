...
.defines(function(){
  var maxPower, minAngle, maxAngle, power, angle, amt, increasingPower, gearCollected;
  MyGame = ig.Box2DGame.extend({
    ...
    killItem: function() {
      ...
      this.controlButtons[0].visible = true;
      this.controlButtons[1].visible = true;
      this.controlButtons[2].visible = true;
    ...
    toss: function() {
      if(this.currentStage == this.throwStages.ANGLE) {
        ...
        this.controlButtons[0].visible = false;
        this.controlButtons[1].visible = false;
        this.controlButtons[2].visible = false;
